 ...
 */
public class LogWriterSAPPISync implements LogWriter {
    ...
    public Response write(final LogMessageContainer logMessageContainer) {
        ...
        try {
            ...
            Logger.getLogger(LogWriterGlassFishSync.class.getName()).log(Level.SEVERE, msgText);
            Logger.getLogger(LogWriterGlassFishSync.class.getName()).log(Level.SEVERE, ex.getMessage());
